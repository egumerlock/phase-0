...
I had trouble deleting eyeColor for a bit because I kept trying to set it to undefined. I looked up on google for help and found the delete command.  That made it work because it deleted the entire property.
Also, to add a property using the [] notation, it is necessary to use quotes around the property name, although it does not translate to a string.  This was a little confusing, but it passed because that is the correct notation.
How difficult was it to add and delete properties outside of the object itself?
At first it was a little difficult, but once I got the hang of it, it was actually very simple.
What did you learn about manipulating objects in this challenge?
I learned that objects are easily manipulatable from outside of the object.  Also, I learned that other objects can be the value of a property.  I had not come across that before in javascript.
